...
async function create(params) {
    ...
    userId: user.id,
    actionType: 'CREATE',
    actionDetails: `User created from IP ${params.ip || 'unknown'} using ${params.browser || 'unknown'}`
});
}
...
async function update(id, params) {
    ...
    userId: user.id,
    actionType: 'UPDATE',
    actionDetails: `User updated from IP ${params.ip || 'unknown'} using ${params.browser || 'unknown'}`
});
}
...
async function _delete(id) {
    ...
    userId: id,
    actionType: 'DELETE',
    actionDetails: `User deleted from IP unknown using unknown browser`
});
}
